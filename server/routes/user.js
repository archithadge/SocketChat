...
router.post('/acceptrequest',auth,catchErrors(userController.acceptrequest));
router.post('/rejectrequest',auth,catchErrors(userController.rejectrequest));
router.post('/leaveroom',auth,catchErrors(userController.leaveroom));
